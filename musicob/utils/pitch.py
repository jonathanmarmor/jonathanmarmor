...
DESCRIPTIONS.update({
    16: ['Theoretical lowest audible pitch'],
    21: ['Piano lowest note'],
    23: ['Six string bass B string'],
    28: ['Bass guitar lowest note', 'Bass guitar E string'],
    33: ['Bass guitar A string'],
    36: ['Cello C string'],
    38: ['Bass guitar D string'],
    40: ['Guitar lowest note', 'Guitar low E string'],
    43: ['Bass guitar G string'],
    45: ['Guitar A string'],
    38: ['Viola C string'],
    50: ['Guitar D string'],
    55: ['Guitar G string', 'Violin lowest note', 'Violin G string'],
    59: ['Guitar B string'],
    60: ['Middle C'],
    62: ['Violin D string'],
    64: ['Guitar high E string'],
    69: ['Violin A string'],
    76: ['Violin E string'],
    83: ['Guitar 19th fret on high E string'],
    100: ['Violin two octaves up on E string'],
    108: ['Piano highest note'],
    135: ['Theoretical highest audible pitch']
})
...
class Pitch(object):
    ...
    def descriptions(self):
        return DESCRIPTIONS[int(self.ps)]
